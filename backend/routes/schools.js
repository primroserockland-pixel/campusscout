...
function transform(r) {
  ...
  // Better GPA estimate from SAT midpoint
  // SAT 800=2.0, 1000=2.7, 1200=3.3, 1400=3.7, 1500=3.85, 1600=4.0
  let gpaAvg = 3.0;
  if (satMid) {
    if (satMid >= 1550) gpaAvg = 3.95;
    else if (satMid >= 1500) gpaAvg = 3.90;
    else if (satMid >= 1450) gpaAvg = 3.85;
    else if (satMid >= 1400) gpaAvg = 3.75;
    else if (satMid >= 1350) gpaAvg = 3.65;
    else if (satMid >= 1300) gpaAvg = 3.55;
    else if (satMid >= 1250) gpaAvg = 3.45;
    else if (satMid >= 1200) gpaAvg = 3.35;
    else if (satMid >= 1150) gpaAvg = 3.20;
    else if (satMid >= 1100) gpaAvg = 3.05;
    else if (satMid >= 1000) gpaAvg = 2.80;
    else gpaAvg = 2.50;
  }
...
router.get('/', async (req, res) => {
  try {
    ...
    schools = schools.filter(s => {
      // GPA filter — hide schools outside range
      if (gpaMin || gpaMax) {
